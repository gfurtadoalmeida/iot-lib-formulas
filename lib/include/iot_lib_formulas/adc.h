...
extern "C"
{
    ...
    /**
     * @brief Calculate the frequency range over which measurements will be taken and
    ...
    /**
     * @brief Calculate the optimal sampling frequency.
    ...
    /**
     * @brief Calculate how many times one needs to sample to increase an ADC resolution.
    ...
    /**
     * @brief Calculate the sampling frequency needed to increase an ADC resolution.
     * @param[in] additional_resolution_bits Number of additional bits needed.
    ...
    /**
     * @brief Calculate the signal-to-noise ratio (ratio of the RMS signal power to
     * the RMS noise power).
    ...
    /**
     * @brief Calculate the effective number of bits (ENOB) necessary to achieve a
    ...
    /**
     * @brief Calculate the least significant bit (LSB) value.
    ...
    /**
     * @brief Calculate the least significant bit (LSB) value, for a differential ADC.
     * @details The LSB is the ADCs voltage interval; the smallest voltage needed
     * to flip a bit on the ADC.
     * @param[in] resolution_bits ADC resolution bits.
